...
(defn fast-memo
  "Variant of [[memo]] that optimizes a common special case: a function with only a single argument.
...
(defn fast-bounded
  "Variant of [[bounded]] that optimizes a common special case: a function with only a single argument.
